        ...
        <div class="fl">
            ...
            <div class="login-form reg-form">
              ...
              <div class="login-box clearfix" style="z-index:100;">
                <label>真实姓名</label>
                <input type="text" id="realName" name="realName" class="input_text" maxlength="25" placeholder="请输入您的真实姓名" autocomplete="off" onblur="userRealName(0);"/>
              ...
              <div class="login-box clearfix " style="z-index:90;">
                <label>身份证号</label>
                <input type="text" id="idCard" name="idCard" class="input_text" maxlength="20"  placeholder="请输入15位或20位身份证号码" autocomplete="off" onblur="idCardCheck();"/>
              ...
              <div class="login-box clearfix" style="z-index:80;">
                ...
                <label>确认身份证号</label>
                <input type="text" id="replayIdCard" name="replayIdCard" class="input_text" maxlength="21"  placeholder="请再次输入15位或20位身份证号码" onblur="idCardEequ()"/>
              ...
              <div class="remember" style="z-index:60;">
                <span class="on">
                <input id="agree" name="agree" type="checkbox"/>我已阅读并同意<a href="javascript:alertBox('mask','agreement');"><font style="color: red;">《枨曦金融网&trade;实名认证服务协议》</font></a>
                </span>
              </div>
              <div class="bn-login">
