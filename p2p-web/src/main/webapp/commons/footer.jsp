      ...
      <div class="footer-section clearfix">
        ...
        <div class="footer-links">
          ...
          <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/loan/loan">产品介绍</a></li>
        ...
        <div class="footer-contactus">
          ...
          <p>客服邮箱：<a style="cursor:pointer;" onclick="location.href='mailto:jiangjc3@foxmail.com'">jiangjc3@foxmail.com</a></p>
        </div>
        <div class="footer-ewm">
          <img src="${pageContext.request.contextPath}/images/weixin01.png" alt="枨曦金融网订阅号" />
          <p>枨曦金融网订阅号</p>
        </div>
        <div class="footer-ewm">
          <img src="${pageContext.request.contextPath}/images/weixin02.png" alt="枨曦金融网服务号" />
          <p>枨曦金融网服务号</p>
        </div>
      </div>
      <div class="copyright">版权所有 ©2019 北京枨曦金融科技有限公司   京ICP备09027468号   |   <img src="${pageContext.request.contextPath}/images/jinghui.png" alt="京公网安备" />京公网安备11030808027468</div>
