...
<div class="headBody" id="headBody">
    <div class="header">
        <div class="mainBox clearfix">
            ...
            <div class="head_r"><a href="javascript:void(0);" id="helpcenter.html">帮助中心</a><em></em><a
                    ...
                    style="margin-right:15px;"><i></i>手机客户端</a>
    ...
    <div class="headCnt clearfix">
        ...
        <ul class="main-nav">
            ...
            <li><h2><a id="information" href="javascript:void(0);"
                       class="/webPage/newInfoDisclosure/company-profile.htm">信息披露<i></i></a></h2></li>
            <li><h2><a id="insurance" href="javascript:void(0);" class="/webPage/index/insurance.html">安全计划<i></i></a>
            </h2></li>
        </ul>
                ...
                <c:choose>
                    <c:when test="${empty user}">
                        ...
                        <div class="no-login"><a href="${pageContext.request.contextPath}/register.jsp"
                                ...
                                href="${pageContext.request.contextPath}/login.jsp" class="btn-login">登录</a></div>
                        <!-- 未登录end -->
                    </c:when>
                    <c:otherwise>
