...
<title>注册枨曦金融网-枨曦金融网,专业的互联网金融信息服务平台</title>
</head>
        ...
        <div class="fl">
            ...
            <div class="login-form reg-form">
              ...
              <div class="remember" style="z-index:60;">
                <span class="on">
                <input id="agree" name="agree" type="checkbox"/>我已阅读并同意<a href="javascript:alertBox('mask','agreement');"><font style="color: red;">《枨曦金融网&trade;注册服务协议》</font></a>
                </span>
              </div>
