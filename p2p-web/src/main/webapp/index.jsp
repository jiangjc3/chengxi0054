		...
		<c:choose>
			...
			<!-- 登录状态  -->
				<div class="register welcome">
					<div class="welcome-txt">欢迎 <span>“<b>${user.phone}</b>”</span><br/>来枨曦金融网投资！</div>
			 ...
			 <div class="inner">
				  ...
				  <div class="index-exper-bottom">
					   <ul class="list cf">
						   ...
						   <li class="box4">
							   <a href="loanInfo?id=${xLoanInfo.id}" class="go-invest">立即投资</a>
						   </li>
					   </ul>
				  </div>
			 </div>
		...
		<!-- 1:已满标时class样式追加 pro-full-->
			<div class="pro-box <c:if test='${uLoanInfo.leftProductMoney == 0}'>pro-full</c:if>">
				...
				<div class="pro-main">
					...
					<div class="pro-btn">
						<a href="loanInfo?id=${uLoanInfo.id}" class="btn-1">立即投资</a>
					</div>
				</div>
			</div>
		</c:forEach>
