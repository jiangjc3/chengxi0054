            ...
            <div class="right-body securityCenter">
                <div class="right-wap">
                    <div class="securityOuter">
                        ...
                        <dl>
                            <dt>
                                <img id="user_photo" src="${pageContext.request.contextPath}/images/header.png"
                                     width="108" height="108"
                                     onerror="this.src='${pageContext.request.contextPath}/images/header.png'"/>
                                <a href="javascript:alert('稍后开启，敬请期待')">上传头像</a>
                            </dt>
                            <dd>
                                <span class="name">姓名</span>
                                <span class="txt" title="">${user.name}</span>
                                <span class="type f_green">已认证</span>
                            </dd>
                            <dd>
                                <span class="name">身份证号</span>
                                <span class="txt">${user.idCard}</span>
                                <span class="type f_green">已认证</span>
                            </dd>
                            <dd>
                    ...
                    <div class="securityOuter address">
                        ...
                        <dl id="addressDiv">
                            <dd style="height:auto;" class="clearfix">
                                ...
                                <span class="txt" id="contactAddress"
                                      style="height:auto;line-height:20px; padding-top:9px;"></span>
