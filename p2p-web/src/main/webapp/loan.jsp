...
<head>
    ...
    <script type="text/javascript" language="javascript"
            src="${pageContext.request.contextPath}/js/huaceng_new.js"></script>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/share.css"/>
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/main.css"/>
    <style type="text/css">body {
        background: #f2f2f2;
    }</style>
    <title>散标,互联网金融产品列表-枨曦金融网,专业的互联网金融信息服务平台</title>
</head>
    ...
    <div class="mainBox pro-list-body clearfix" id="rollingLayer">
                ...
                <tr>
                    <td>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a id="lnkNext"
                                   href="${pageContext.request.contextPath}/loan/loan?ptype=${ptype}">首页</a>
                                <a id="lnkNext"
                                   href="${pageContext.request.contextPath}/loan/loan?ptype=${ptype}&currentPage=${currentPage-1}">上一页</a>
                            </c:otherwise>
                        </c:choose>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <a id="lnkNext"
                                   href="${pageContext.request.contextPath}/loan/loan?ptype=${ptype}&currentPage=${currentPage+1}">下一页 </a>
                                <a id="lnkNext"
                                   href="${pageContext.request.contextPath}/loan/loan?ptype=${ptype}&currentPage=${totalPage}">尾页</a>
                            </c:otherwise>
                        </c:choose>
                    </td>
                </tr>
        ...
        <div class="right-side">
            <div class="side-box fixed" id="roll" style="top: 0px;">
                ...
                <div class="system-notice" style="margin-top: 0px;">
                    ...
                    <ul>
                        <c:forEach items="${bidUserTopList}" var="topUser" varStatus="index">
                            <li>
                                <span>${index.count}.&nbsp;&nbsp;${fn:substring(topUser.phone, 0, 3)}******${fn:substring(topUser.phone, 9,11 )}&nbsp;${topUser.score}</span>
                            </li>
                        </c:forEach>
                    </ul>
                </div>
                <!--投资排行榜end-->
                <!--广告位begin-->
                <div style="margin-top:20px;"><a href="${pageContext.request.contextPath}/"><img
                        src="${pageContext.request.contextPath}/images/ad.jpg" alt=""/></a></div>
                <!--广告位end-->
            </div>
        </div>
    </div>
