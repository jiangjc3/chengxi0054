...
<head>
    ...
    <meta name="keywords"
          content="枨曦金融网，枨曦金融，枨曦金融财富,金元宝，金元宝，网络理财，个人理财，投资理财，P2P理财，互联网金融，投资理财，债权转让，理财，网络贷款，个人贷款，理财服务，网贷，小额贷款，网络投融资平台, 网络理财,固定收益,100%本息保障"/>
    <meta name="description" content="枨曦金融网用户注册，专业的互联网金融信息服务平台"/>
    <title>登录枨曦金融网-枨曦金融网,专业的互联网金融信息服务平台</title>
            ...
            <div class="login-cnt clearfix">
                <div class="login-form">
                    ...
                    <div class="login-box clearfix" style="z-index:10;">
                        ...
                        <input id="phone" name="phone" type="text" class="input_text" placeholder="请输入11位手机号码"
                               maxlength="11" onblur="checkPhone();"/>
                    </div>
                    ...
                    <div class="login-box clearfix" style="z-index:8; padding-bottom:0px;">
                        ...
                        <input id="loginPassword" name="loginPassword" type="password" placeholder="请输入登录密码"
                               class="input_text" maxlength="16" onblur="checkLoginPassword();"/>
                    </div>
                    ...
                    <div class="login-yzm">
                        <div id="showCaptcha" class="yzm-box" style="display:block;">
                            <input id="captcha" type="text" class="yzm" placeholder="点击右侧图片可刷新"
                                   onblur="checkCaptcha();"/>
                            <img src="${pageContext.request.contextPath}/jcaptcha/captcha" alt="图片看不清？点击重新得到验证码"
                                 id="imgCode"
                                 onclick="this.src='${pageContext.request.contextPath}/jcaptcha/captcha?d='+new Date().getTime()"
                ...
                <div class="login-right">
                    ...
                    <div class="top-txt">
                        枨曦金融网，便捷的投资平台
                        <br/><br/>
                        加入枨曦金融网<br/>坐享<span class="historyAverageRate">--</span>%历史年化收益
                    </div>
